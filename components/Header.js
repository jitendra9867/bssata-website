                    ...
                    <DropdownMenu isOpen={openDropdown === link.label} alignRight={alignRight}>
                      {link.children.map((child) => (
                        <Link
                          ...
                          className={`block px-4 py-2.5 text-sm font-normal transition-all duration-200 ${
              ...
              <div key={link.href}>
                <div className="flex items-center">
                  <Link
                    href={link.href}
                    onClick={() => setMobileOpen(false)}
                    className="flex-1 flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-normal text-gray-600 hover:text-saffron-600 hover:bg-saffron-50/70 transition-all duration-200"
                  >
